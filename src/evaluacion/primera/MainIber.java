...
public class MainIber
{
    ...
    public static void main(String args[]){
    	...
    	region.setI_region_id(850);
    	region.setS_region_name("Antartida");
    	...
    	try 
    	{
			...
			List<RegionDTO> list = session.createSQLQuery("SELECT * FROM REGIONS").addEntity(RegionDTO.class).list();
